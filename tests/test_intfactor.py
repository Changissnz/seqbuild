...
class IntFactorMethods(unittest.TestCase):
    ...
    def test__ISFactorSetOps__dsort(self):
        ...
        assert dx2 == [[15, 1], [24, 1], [30, 1], [480, 1], \
            ...
            [4, 5], [1, 8]],"got {}".format(np.array(dx2,dtype=int))
        '''

        sol2 = np.array([[  15,1],[  24,1],[  30,1],[  48,1],\
                [  60,1],[ 480,1],[  96,1],[ 240,1],[ 120,1],\
                [6400,1],[3200,1],[ 400,1],[  25,1],[ 800,1],[  50,1],\
                [1600,1],[ 200,1],[ 100,1],[ 804,1],[ 134,1],[  67,1],[ 201,1],\
                [ 268,1],[ 402,1],[   7,1],[  19,1],[  11,1],[   3,2],[   6,2],\
                [  12,2],[1280,2],[ 256,2],[ 128,2],[ 640,2],[ 320,3],[  64,3],\
                [   5,4],[   8,4],[  10,4],[  16,4],[  20,4],[ 160,4],[  32,4],\
                [  40,4],[  80,4],[   2,5],[   4,5],[   1,8]])
        assert np.all(dx2 == sol2)


        dx3 = isfso.median_sort(pkeys=None,r=0.5,fullpair_sequence=False) 
        sol3 = [402, 7, 268, 19, 201, 11, 67, 3, 134, \
                6, 804, 12, 100, 1280, 200, 256, 1600, \
                128, 50, 640, 800, 320, 25, 64, 400, 5, \
                3200, 8, 6400, 10, 120, 16, 240, 20, 96, \
                160, 480, 32, 60, 40, 48, 80, 30, 2, 24, \
                4, 15, 1]
        """
        assert dx3 == [402, 7, 268, 19, 201, 11, 67, 3, \
            ...
            240, 160, 96, 32, 480, 40, 30, 2, 24, 4, 15, 1],"got {}".format(\
                [int(dx3_) for dx3_ in dx3])
        """

        assert np.all(sol3 == dx3) 
